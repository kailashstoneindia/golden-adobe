...
>
> What still holds, and is the reason this file is kept: **the core principle below** —
> Postgres is the source of truth, search reads a derived denormalized index — and
> *"design the flattened document shape now even if you don't build the sync pipeline yet."*
